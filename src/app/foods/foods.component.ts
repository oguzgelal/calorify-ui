...
export class FoodsComponent implements OnInit {
  ...
  addRecipe() {
    sweetAlert("Recipe saved!", "Now you can use this recipe within your account.", "success");
    this.addedRecipe = {
      name: '',
      image: '',
      desc: ''
  ...
  addFood() {
    sweetAlert("Food saved!", "Now you can use this food within your account.", "success");
    this.addedFood = {
      name: '',
      image: '',
      portionSize: '',
